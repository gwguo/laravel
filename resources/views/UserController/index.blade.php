    ...
    <ul class="userNav">
        ...
        <div class="state">
            ...
            <dl>
                ...
                <dd><a href="/order/order">全部订单</a></dd>
            </dl>
            <div class="clearfix"></div>
        </div><!--state/-->
        <li><span class="glyphicon glyphicon-usd"></span><a href="quan.html">我的优惠券</a></li>
        <li><span class="glyphicon glyphicon-map-marker"></span><a href="/address/add">收货地址管理</a></li>
        <li><span class="glyphicon glyphicon-star-empty"></span><a href="/collect">我的收藏</a></li>
